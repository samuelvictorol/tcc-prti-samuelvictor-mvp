...
const listGroupsSchema = z.object({
  query: paginationQuery.extend({ search: z.string().max(200).optional(), source: z.enum(['manual', ...DELIVERY_CHANNELS]).optional() })
});

module.exports = { createGroupSchema, updateGroupSchema, groupIdSchema, listGroupsSchema };
