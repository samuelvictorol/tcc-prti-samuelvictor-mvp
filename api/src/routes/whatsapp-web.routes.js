...
const { channelSendSchema, whatsappWebMessagesSchema, whatsappWebGroupSchema } = require('../dtos/channels.dto');
...
router.get('/groups', requireWhatsappWebReady, asyncHandler(controller.groups));
router.post('/groups', requireWhatsappWebReady, validate(whatsappWebGroupSchema), asyncHandler(controller.createGroup));
router.post('/sync', requireWhatsappWebReady, asyncHandler(controller.sync));
router.post('/send', requireWhatsappWebReady, validate(channelSendSchema), asyncHandler(controller.send));
